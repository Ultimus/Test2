...
public class Bomb {
	...
	// b1, b2 und b3 sind verschiedene Rauchbilder. b1 ist das unterste b3 das Oberste
	// die Bilder werden uebereinander gelegt und sollen so eine Explosion simulieren
	...
	public Bomb(double xPar, double yPar){
