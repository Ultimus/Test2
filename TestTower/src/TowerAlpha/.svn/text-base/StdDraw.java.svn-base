...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static final Color MM_SEABLUE       = new Color(  7, 127, 240); // old Color(  9,  90, 166);
    ...
    private static final double BORDER = 0.0; // MODXXX old: 0.05 new: 0
    ...
    private static void init() {
        ...
        frame.setTitle("TowerDefense");
        //frame.setJMenuBar(createMenuBar()); // MODXXX removed the menu bar
        frame.pack();
...
*/
    ...
    *************************************************************************/
    ...
    public static void show(int t) {
        defer = false;
        draw();
        try { Thread.sleep(t); } // currentThread()
